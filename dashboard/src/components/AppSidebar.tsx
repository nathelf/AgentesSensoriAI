...
import { LayoutDashboard, MessageCircle, Bot, Zap, Activity } from "lucide-react";
    ...
    <aside className="w-[260px] min-h-screen border-r border-white/[0.05] bg-[hsl(var(--sidebar-background))] flex flex-col">
      ...
      <div className="p-5 border-b border-white/[0.05]">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center glow-success">
            <Bot className="w-5 h-5 text-primary" strokeWidth={1.5} />
          </div>
          <div>
            <h1 className="text-sm font-bold text-foreground tracking-tight">SensoriAI</h1>
